...
This forces software engineers to turn to ways of representing metadata that result in unreliable systems with limited evolvability.
...
The core principles of the presented implementation lay the groundwork for a more general framework independent approach.
