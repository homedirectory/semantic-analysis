...
In this work, we develop a technology for compile time semantic analysis that would capture the description of a conceptual schema in a form of metadata modeled in the source code.
% what methods do you use
We focus on the Java programming language in particular, taking advantage of the annotation processing capabilities. 
