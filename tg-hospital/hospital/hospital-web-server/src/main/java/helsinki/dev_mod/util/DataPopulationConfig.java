...
/**
 * Provides Helsinki Hospital Asset Management specific implementation of {@link IDomainDrivenTestCaseConfiguration} to be used for creation and population of the target development database from within of IDE.
 *
 * @author TG Team
 *
 */
public final class DataPopulationConfig implements IDomainDrivenTestCaseConfiguration {
    ...
    public DataPopulationConfig(final Properties props) {
    	...
    	try {
    	    ...
    	    props.setProperty("app.name", "Helsinki Hospital Asset Management");
    	    props.setProperty("reports.path", "");
    	    props.setProperty("domain.path", "../hospital-pojo-bl/target/classes");
    	    props.setProperty("domain.package", "helsinki");
    	    props.setProperty("tokens.path", "../hospital-pojo-bl/target/classes");
    	    ...
    	    props.setProperty("email.fromAddress", "hospital_support@helsinki.com.ua");
